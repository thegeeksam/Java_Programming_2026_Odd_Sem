 ...
 * * It can have default or static methods too, but only one
 * * method is abstract. This makes it ideal for lambda expressions,
 * * which are anonymous functions that implement that single method.
 * *
